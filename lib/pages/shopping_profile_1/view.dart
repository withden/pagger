              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(Symbols.camera, size: 18, color: theme.colorScheme.onPrimaryContainer),
                        ),
                      )
                    ],
                  )),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(Symbols.package, size: 22, color: theme.colorScheme.onSurface),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Symbols.featured_seasonal_and_gifts, size: 22, color: theme.colorScheme.onSurface),
                              const SizedBox(width: 8),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Symbols.help, size: 22, color: theme.colorScheme.onSurface),
                              const SizedBox(width: 8),
                  ...
                  ListTile(
                      ...
                      leading: Icon(Symbols.person, size: 22, color: theme.colorScheme.onSurface),
                  ...
                  ListTile(
                      ...
                      leading: Icon(Symbols.person_add, size: 22, color: theme.colorScheme.onSurface),
                      trailing: Icon(Symbols.chevron_right, size: 22, color: theme.colorScheme.onSurface),
                  ...
                  FilledButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Symbols.logout, color: theme.colorScheme.onErrorContainer, size: 18),
